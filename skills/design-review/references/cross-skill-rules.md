...
**规则**:任何在 `docs/` 或 `skills/<style>/references/canonical/` 下的 HTML,都会被 GitHub Pages 发布到 `doc.tbusos.com/proofmark/`(公开站的一部分)。这些页面 **必须** 支持中英切换,理由:
...
3. 我的中文母语用户在 proofmark 是一等公民,不是 i18n afterthought。
