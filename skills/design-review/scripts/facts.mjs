...
// Empty on purpose. The nine flagship demos live upstream in sky-skills, where
// they retell *that* repo ("22 skills") — carrying them here would have meant
// nine pages advertising another repo, ten of whose links point at skills this
// repo does not contain. The showcase here is the canonical specimen library
// (59 pages under skills/*/references/canonical/), which makes no repo-level
// claims and so has nothing to go stale. The mechanism stays wired up so a
// future proofmark-native demo set is one line away.
